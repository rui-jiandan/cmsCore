...
namespace LinCms.Cms.Account
{
    public class AccountService : IAccountService
    {
        ...
        private readonly ICache _cacheHelp;
        ...
        public async Task<string> SendComfirmEmail(RegisterDto registerDto)
        {
            ...
            await _cacheHelp.SetAsync("SendComfirmEmail-" + registerDto.Email, uuid, TimeSpan.FromMinutes(30));
...
祝您使用愉快，使用过程中您有任何问题请及时联系我们。</br>"
        ...
        public async Task SendEmailCode(RegisterDto registerDto)
        {
            ...
            string uuid = Guid.NewGuid().ToString();
            await _cacheHelp.SetAsync("SendEmailCode-" + registerDto.Email, uuid, TimeSpan.FromMinutes(30));
        ...
        public async Task<string> SendPasswordResetCode(SendEmailCodeInput sendEmailCode)
        {
            ...
            await _cacheHelp.SetAsync(user.Email, rand6Value, TimeSpan.FromMinutes(30));
        ...
        {
            string resetCode = await _cacheHelp.GetAsync(resetPassword.Email);
